...
typedef struct ElementPos {
    ElementPos()
        ...
        , offsetY(0)
        , origin(TL){};
    ElementPos(float x, float y)
        : x(x)
        , y(y)
        , offsetX(0)
        , offsetY(0)
        , origin(TL){};
    ElementPos(float x, float y, int offsetX, int offsetY)
        : x(x)
        , y(y)
        , offsetX(offsetX)
        , offsetY(offsetY)
...
typedef struct ElementDim {
    ElementDim()
        ...
        , pixelH(0)
        , AR(0.0){};
    ElementDim(float w, float h, int pixelW, int pixelH)
        : w(w)
        , h(h)
        , pixelW(pixelW)
        , pixelH(pixelH)
        , AR(0.0f){};
    ElementDim(float w, int pixelW, float AR)
        : w(w)
        , h(0)
        , pixelW(pixelW)
        , pixelH(0)
